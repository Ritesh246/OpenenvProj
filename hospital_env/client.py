...
"""Hospital Env Environment Client."""
...
class HospitalEnv(
    ...
    """
    Client for the Hospital Env Environment.
    ...
    Example:
        ...
        ...
        ...     result = client.step(HospitalAction(message="Hello!"))
        ...     print(result.observation.echoed_message)

    Example with Docker:
        >>> # Automatically start container and connect
        >>> client = HospitalEnv.from_docker_image("hospital_env-env:latest")
        >>> try:
        ...     result = client.reset()
        ...     result = client.step(HospitalAction(message="Test"))
        ... finally:
        ...     client.close()
    """
